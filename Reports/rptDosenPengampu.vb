...
Public Class rptDosenPengampu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APK_Penjadwalan_Matakuliah_TRPL_OOP.rptDosenPengampu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prmSemester() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDosenPengampu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDosenPengampu = New rptDosenPengampu()
        rpt.Site = Me.Site
        Return rpt
    End Function
